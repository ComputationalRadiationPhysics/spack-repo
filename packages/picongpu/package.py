...
class Picongpu(Package):
    ...
    depends_on('boost@1.62.0:1.70.0 cxxstd=11 +math +system +program_options +filesystem +serialization', when='@:0.5.0')
    depends_on('boost@1.65.1:1.70.0 cxxstd=11 +math +system +program_options +filesystem +serialization', when='@:0.5.0 backend=cuda ^cuda@9:')
    depends_on('boost@1.65.1:1.70.0 cxxstd=14 +math +system +program_options +filesystem +serialization', when='@0.6.0:')
    depends_on('boost@1.74.0: cxxstd=17 +math +system +program_options +filesystem +serialization', when='@develop')
    ...
    depends_on('isaac@1.6.0', when='@0.6.0 +isaac')
    ...
    depends_on('isaac-server@1.6.0', type='run', when='@0.6.0 +isaac')
    depends_on('isaac-server@develop', type='run', when='@develop: +isaac')
    depends_on('openpmd-api@0.13.2:', when='@0.6.0: +openpmd')
    depends_on('openpmd-api@0.14.3:,dev', when='@develop +openpmd')
